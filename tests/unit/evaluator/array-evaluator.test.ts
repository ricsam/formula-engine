...
describe('Array Evaluator', () => {
  describe('getArrayDimensions', () => {
    ...
    test('should get dimensions of 2D array', () => {
      expect(getArrayDimensions([[1, 2], [3, 4], [5, 6]])).toEqual({ rows: 3, cols: 2 });
  ...
  describe('areDimensionsCompatible', () => {
    ...
    test('broadcastable dimensions are compatible', () => {
      expect(areDimensionsCompatible(
        { rows: 3, cols: 1 },
        { rows: 3, cols: 4 }
      )).toBe(true);
  ...
  describe('broadcast', () => {
    test('should broadcast scalar to array', () => {
      const result = broadcast([[42]], [[1, 2], [3, 4]]);
      
      expect(result).not.toBe('#VALUE!');
      if (typeof result !== 'string') {
        expect(result.array1).toEqual([[42, 42], [42, 42]]);
        expect(result.array2).toEqual([[1, 2], [3, 4]]);
        expect(result.dimensions).toEqual({ rows: 2, cols: 2 });
      }
    });

    test('should broadcast column to matrix', () => {
      const result = broadcast([[1], [2]], [[10, 20, 30], [40, 50, 60]]);
      
      expect(result).not.toBe('#VALUE!');
      if (typeof result !== 'string') {
        expect(result.array1).toEqual([[1, 1, 1], [2, 2, 2]]);
  ...
  describe('broadcastToSize', () => {
    ...
    test('should return error for invalid broadcast', () => {
      const result = broadcastToSize([[1, 2], [3, 4]], { rows: 3, cols: 3 });
      expect(result).toBe('#VALUE!');
    });
  ...
  describe('elementWiseBinaryOp', () => {
    ...
    test('should broadcast and operate', () => {
      const multiply = (a: CellValue, b: CellValue) => (a as number) * (b as number);
      const result = elementWiseBinaryOp(
        [[2]],
        [[1, 2, 3], [4, 5, 6]],
        multiply
    ...
    test('should propagate errors', () => {
      ...
      expect(result).toEqual([[11, '#DIV/0!'], [33, 44]]);
    });
    ...
    test('should return error for incompatible arrays', () => {
      ...
      const result = elementWiseBinaryOp(
        [[1, 2], [3, 4]],  // 2x2 array
        [[1, 2, 3], [4, 5, 6]],  // 2x3 array - incompatible column dimensions
        add
      );
  ...
  describe('elementWiseUnaryOp', () => {
    ...
    test('should propagate errors', () => {
      ...
      expect(result).toEqual([[2, '#REF!'], [6, 8]]);
    });
  });

  describe('reduceArray', () => {
    test('should reduce to scalar', () => {
      const sum = (acc: CellValue, val: CellValue) => (acc as number) + (val as number);
  ...
  describe('filterArray', () => {
    test('should filter based on conditions', () => {
    ...
    test('should broadcast conditions', () => {
      const result = filterArray(
        [[1, 2], [3, 4], [5, 6]],
        [[true, false]]
      );
    ...
    test('should return empty column if no matches', () => {
      const result = filterArray(
        [[1, 2, 3]],
        [[false, false, false]]
      );
    ...
    test('should propagate errors in conditions', () => {
      const result = filterArray(
        [[1, 2, 3]],
        [[true, '#VALUE!', false]]
      );
  ...
  describe('transpose', () => {
    ...
    test('should handle undefined values', () => {
      const result = transpose([[1, undefined], [undefined, 2]]);
      expect(result).toEqual([[1, undefined], [undefined, 2]]);
    });
  });
  ...
  describe('coerceToBoolean', () => {
    ...
    test('should handle undefined and errors', () => {
      ...
      expect(coerceToBoolean('#VALUE!')).toBe(false);
    });
  });
  ...
  describe('calculateSpillRange', () => {
    test('should calculate spill range', () => {
      const result = calculateSpillRange(5, 10, [[1, 2, 3], [4, 5, 6]]);
  ...
  describe('arraySum', () => {
    ...
    test('should skip non-numeric values', () => {
      expect(arraySum([[1, 'text', 2], [undefined, 3, '#VALUE!']])).toBe(6);
    });

    test('should return 0 for no numeric values', () => {
      expect(arraySum([['a', 'b'], ['c', 'd']])).toBe(0);
    });
  });
  ...
  describe('arrayProduct', () => {
    ...
    test('should skip non-numeric values', () => {
      expect(arrayProduct([[2, 'text', 3], [undefined, 4]])).toBe(24);
    });
  ...
  describe('arrayCount', () => {
    test('should count numeric values', () => {
      expect(arrayCount([[1, 2, 3], [4, 5, 6]])).toBe(6);
    });
    ...
    test('should skip non-numeric values', () => {
      expect(arrayCount([[1, 'text', 2], [undefined, 3, '#VALUE!']])).toBe(3);
    });

    test('should return 0 for no numeric values', () => {
      expect(arrayCount([['a', 'b'], [undefined, undefined]])).toBe(0);
    });
  });
