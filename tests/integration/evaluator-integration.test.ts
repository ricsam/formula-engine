...
describe('Evaluator Integration Tests', () => {
  ...
  function evaluateFormula(formula: string): CellValue {
    try {
  ...
  describe('Logical functions', () => {
    ...
    test('should evaluate complex conditions', () => {
      expect(evaluateFormula('=IF(AND(A1>5,B1<30),"Pass","Fail")')).toBe('Pass');
  ...
  describe('Array operations', () => {
    test('should evaluate array literals', () => {
      ...
      const result1 = evaluateFormula('={1,2,3}') as unknown as number[][];
      expect(result1).toEqual([[1, 2, 3]]);
      
      const result2 = evaluateFormula('={1;2;3}') as unknown as number[][];
      expect(result2).toEqual([[1], [2], [3]]);
      
      const result3 = evaluateFormula('={1,2;3,4}') as unknown as number[][];
    ...
    test('should evaluate array formulas', () => {
      ...
      const result3 = evaluateFormula('={1,2,3}+{10,20,30}') as unknown as number[][];
  ...
  describe('Complex formulas', () => {
    test('should evaluate nested functions', () => {
      ...
      expect(evaluateFormula('=CONCATENATE("Total: ",SUM(A1:C1))')).toBe('Total: 60');
    });
